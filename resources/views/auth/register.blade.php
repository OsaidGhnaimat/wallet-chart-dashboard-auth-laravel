            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="user_img" class="col-md-4 col-form-label text-md-end">{{ __('User Image') }}</label>

                            <div class="col-md-6">
                                <input id="user_img" type="file" class="form-control @error('user_img') is-invalid @enderror" name="user_img" value="{{ old('user_img') }}" >
